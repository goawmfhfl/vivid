...
export function buildFeedbackPrompt(
  ...
  const instruction = isPro
    ? [
        ...
        "",
        "4) feedback_ai_comment:",
        "- 피드백에 대한 AI의 따뜻한 코멘트를 작성하세요.",
        "- 조언보다는 공감과 응원의 톤으로 작성하세요.",
        "",
        "5) ai_message:",
        "- 사용자를 응원하는 메시지를 작성하세요.",
        "- 하루를 마무리하며 앞으로의 성장을 격려하는 따뜻한 문장으로 작성하세요.",
        "",
        "6) feedback_person_traits:",
    ...
    : [
        ...
        "3) improvements는 개선할 점을 2~3개 정도만 간결하게 작성하세요.",
        "4) feedback_ai_comment는 사용자의 피드백을 가볍게 요약하거나 응원하는 한두 문장으로 작성하세요.",
        "5) ai_message는 Free 유저에서는 null로 설정하세요. (Pro 전용 필드입니다.)",
        "6) feedback_person_traits는 Free 유저에서는 null로 설정하세요. (Pro 전용 필드입니다.)",
        "7) encouragement_message는 Free 유저에서는 null로 설정하세요. (Pro 전용 필드입니다.)",
      ].join("\n");
