...
export function buildReportPrompt(
  ...
  const instruction = [
    ...
    "- [페르소나가 제공된 경우] 이 사용자의 알려진 성향·패턴과 오늘 기록을 연결하는 문장을 1개 정도 자연스럽게 넣어 '너의 성향을 기억하고 있다'는 인상을 주세요. 과하지 않게.",
    "",
    "3) current_keywords:",
    ...
    "- [페르소나가 제공된 경우] 사용자의 지향하는 자아·원동력과 오늘 비전의 연결을 1문장 정도로 자연스럽게 언급하세요.",
    "",
    "6) future_keywords:",
