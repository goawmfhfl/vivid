...
interface CreateDailyVividButtonProps {
  selectedDate: Date;
}

export function CreateDailyVividButton({
  selectedDate,
}: CreateDailyVividButtonProps) {
  ...
  const handleClick = async () => {
    ...
    try {
      const createdFeedback = await createDailyVivid.mutateAsync({
        date: dateStr,
      });
