  ...
  const sectionDefinitions = [
    {
      ...
      fields: [
        ...
        { name: "date_range", path: "view.date_range", isPro: false },
        {
          ...
          path: "view.summary_report.monthly_summary",
          isPro: false,
        },
        {
          name: "key_themes",
          path: "view.summary_report.key_themes",
          isPro: false,
        },
        {
          name: "monthly_scores",
          path: "view.summary_report.monthly_scores",
          isPro: false,
        },
        {
          name: "weekly_scores_trend",
          path: "view.summary_report.weekly_scores_trend",
          isPro: true,
        },
      ],
      condition: "항상 표시",
    ...
    },
    {
      ...
      fields: [
        {
          name: "summary",
          path: "view.emotion_report.summary",
          isPro: false,
        },
        {
          name: "monthly_emotion_overview",
          path: "view.emotion_report.monthly_emotion_overview",
          isPro: false,
        },
        {
          name: "weekly_emotion_evolution",
          path: "view.emotion_report.weekly_emotion_evolution",
          isPro: true,
        },
        {
          name: "emotion_pattern_changes",
          path: "view.emotion_report.emotion_pattern_changes",
          isPro: true,
        },
        {
          name: "visualization",
          path: "view.emotion_report.visualization",
          isPro: true,
        },
      ],
      condition: "emotion_report.summary !== ''",
    },
    {
      name: "Vision",
