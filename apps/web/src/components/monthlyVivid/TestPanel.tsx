      ...
      fields: [
        {
          ...
          path: "view.report.vision_evolution",
          isPro: false,
        },
        {
          name: "alignment_analysis",
          path: "view.report.alignment_analysis",
          isPro: false,
        },
        {
          name: "daily_life_patterns",
          path: "view.report.daily_life_patterns",
          isPro: false,
        },
        {
          name: "identity_alignment",
          path: "view.report.identity_alignment",
          isPro: false,
        },
        {
          name: "next_month_plan",
          path: "view.report.next_month_plan",
          isPro: false,
        },
      ],
