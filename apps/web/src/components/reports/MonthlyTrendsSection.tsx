...
const MONTHLY_PREVIEW_DATA = {
  recurring_self: [
    "[26년01월]: 기술적 성취와 가정의 행복을 함께 키우며, 진정성 있는 1인 사업가로 나아가고 있어요",
    "[25년12월]: 꾸준히 실천하려 하고, 한 번 정한 일은 끝까지 해내는 편이에요",
  ],
  effort_to_keep: [
    "[26년01월]: 완벽함보다 진심을 담는 것, 그리고 사랑하는 가족과 함께하는 따뜻한 균형을 지키려 했어요",
    "[25년12월]: 꾸준함과 끈기를 지키기 위해 작은 것부터 시작하는 습관을 유지했어요",
  ],
  most_meaningful: [
    "[26년01월]: 건강한 습관들과 아내와 함께 나누는 저녁 시간의 편안함이 가장 의미 있었어요",
    "[25년12월]: 매일 아침 스스로를 다잡는 긍정의 힘이 원동력이 되어주었어요",
  ],
  biggest_change: [
    "[26년01월]: 개발자로서의 자신감이 쑥쑥 자라고, 완벽하고 싶은 마음과 싸우며 꾸준히 노력하는 사람으로 변했어요",
