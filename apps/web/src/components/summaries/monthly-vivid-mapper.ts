...
/**
 * MonthlyVividListItem으로부터 PeriodSummary 객체 생성
 */
export function createPeriodSummaryFromMonthlyVivid(
...
/**
 * MonthlyVividListItem을 PeriodSummary로 변환
 */
export function convertMonthlyVividToPeriodSummary(
  item: MonthlyVividListItem
): PeriodSummary {
  ...
  return createPeriodSummaryFromMonthlyVivid({
    item,
    year,
    monthNumber,
    dateRange,
