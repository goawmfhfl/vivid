        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            <div>
              ...
              >
                {["gpt-4o", "gpt-4o-mini", "gpt-5-mini"].includes(model)
                  ? "최신 모델은 1.0으로 고정됩니다"
            ...
            <Input
              ...
              onChange={(e) => {
                if (!["gpt-4o", "gpt-4o-mini", "gpt-5-mini"].includes(model)) {
              ...
              max="2"
              step="0.1"
              disabled={["gpt-4o", "gpt-4o-mini", "gpt-5-mini"].includes(model)}
              style={{
                backgroundColor: COLORS.background.base,
                border: `1px solid ${COLORS.border.light}`,
                opacity: ["gpt-4o", "gpt-4o-mini", "gpt-5-mini"].includes(model)
                  ? 0.6
                  : 1,
              }}
            />
