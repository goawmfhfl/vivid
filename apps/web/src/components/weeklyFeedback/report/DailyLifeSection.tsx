    ...
    <div className="mb-10 sm:mb-12">
      ...
      {isPro ? (
        <div className="space-y-4">
          ...
          {/* 이번 주 루틴을 보아하니, 나는 이런 일상을 보낸 사람이었어요 - Pro 전용 */}
          {dailyLifeReport.daily_life_characteristics &&
            dailyLifeReport.daily_life_characteristics.length > 0 && (
              <Card
                className="p-5 sm:p-6 mb-4"
                style={{
                  background:
              ...
              >
                ...
                <div className="pt-0">
                  <ul className="space-y-3">
                    {dailyLifeReport.daily_life_characteristics.map(
                      (characteristic, idx) => (
                        <li
                          key={idx}
          ...
          {/* Behavioral Patterns & Daily Rhythm 통합 UI */}
            ...
            >
              ...
              <div className="pt-0">
                ...
                {dailyLifeReport.growth_insights.strengths_highlighted &&
                  dailyLifeReport.growth_insights.strengths_highlighted.length >
                    0 && (
                    <div className="mb-4">
                      <p
                        className="text-xs mb-2 font-medium"
