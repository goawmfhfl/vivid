      ...
      fields: [
        {
          ...
          path: "view.report.weekly_vivid_summary",
          isPro: false,
        },
        {
          name: "weekly_keywords_analysis",
          path: "view.report.weekly_keywords_analysis",
          isPro: false,
        },
        {
          name: "future_vision_analysis",
          path: "view.report.future_vision_analysis",
          isPro: false,
        },
        {
        ...
        },
        {
          ...
          path: "view.report.user_characteristics_analysis",
          isPro: false,
        },
        {
          name: "aspired_traits_analysis",
          path: "view.report.aspired_traits_analysis",
          isPro: false,
        },
        {
          name: "weekly_insights",
          path: "view.report.weekly_insights",
          isPro: false,
        },
      ],
